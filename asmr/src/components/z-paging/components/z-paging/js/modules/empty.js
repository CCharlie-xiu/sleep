...
export default {
	props: {
		...
		noNetworkImg: {
			type: [String, Object],
			default: u.gc('noNetworkImg', null)
		},
		// 空数据图 无网络 描述
		noNetworkText: {
			type: [String, Object],
			default: u.gc('noNetworkText', null)
		}
	...
	computed: {
		finalEmptyViewImg() {
			return this.isLoadFailed === null ? this.noNetworkImg : this.isLoadFailed ? this.emptyViewErrorImg : this.emptyViewImg;
		},
		finalShowEmptyViewReload() {
			return this.isLoadFailed === null ? true : this.isLoadFailed ? this.showEmptyViewReloadWhenError : this.showEmptyViewReload;
		},
		// 是否展示空数据图
		showEmpty() {
