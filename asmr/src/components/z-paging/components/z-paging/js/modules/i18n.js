...
export default {
	computed: {
		...
		// 最终的空数据图title
		finalEmptyViewText() {
			return this.isLoadFailed === null ? this.noNetworkText :  this.isLoadFailed ? this.finalEmptyViewErrorText : this._getI18nText('zp.emptyView.title', this.emptyViewText);
		},
		// 最终的空数据图reload title
