<template>
	<view v-if="show" class="uni-noticebar"    :style="{ ...customStyle, backgroundColor }" @click="onClick">
		<slot v-if="showIcon === true || showIcon === 'true'" name="noticebarIcon">
			<tn-icon class="uni-noticebar-icon" name="sound" :color="color" :size="fontSize * 1.5" />
		</slot>
		<view ref="textBox" class="uni-noticebar__content-wrapper" :class="{
			...
			<view :id="elIdBox" class="uni-noticebar__content" :class="{
				...
				<view :id="elId"  ref="animationEle" class="uni-noticebar__content-text" :class="{
		...
		<view v-if="isShowGetMore" class="uni-noticebar__more uni-cursor-point" @click="clickMore">
			...
			<tn-icon v-else name="right" :color="moreColor" :size="fontSize * 1.1" />
		</view>
		<view class="uni-noticebar-close uni-cursor-point" v-if="isShowClose">
			<tn-icon name="close" :color="color" :size="fontSize * 1.1" @click="close" />
		</view>
	</view>
</template>
