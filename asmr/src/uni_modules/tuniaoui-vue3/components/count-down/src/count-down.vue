...
<template>
  <view :class="[countDownClass]" :style="countDownStyle">
    <!-- 日 -->
    <template v-if="day">
      <view class="day" :class="[textClass]" :style="{...textStyle, ...boxStyle}">{{ day }}</view>
    ...
    <!-- 时 -->
    <template v-if="hour">
      <view class="hour" :class="[textClass]" :style="{...textStyle, ...boxStyle}">
        {{ hour }}
      </view>
    ...
    <template v-if="minute">
      <view class="minute" :class="[textClass]" :style="{...textStyle, ...boxStyle}">
        {{ minute }}
      </view>
    ...
    <template v-if="second">
      <view class="second" :class="[textClass]" :style="{...textStyle, ...boxStyle}">
        {{ second }}
      </view>
      <view
